# FILE: interaction_strategies.py
...
class ChatbotStrategy(InteractionStrategy):
    ...
    async def execute_and_get_response(self, page: Page, prompt: str) -> str:
        # The robust selector for finding a chat input box
        ...
        # Wait for the chatbot to stop responding
        await page.wait_for_selector('[data-testid="stChatMessage"]:last-child [data-testid="stMarkdownContainer"] p', state='attached', timeout=60000)
        
        # Get the text of the very last message on the page
